...
((
Definition of thermodynamics, statistical physics and soft matter
Quick review to binomial and gaussian distribution
Central limit theorem (Wiener process)
MSD (mean squared deviation)
Brownian motion (Langevin equation?)
Microstates, macrostates and phase space
Diffusion (Fick's laws of diffusion)
...
Reversibility of processes (from diap. 179 Käs)
Reversible process
